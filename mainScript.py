...
def plot_main(smoothed, methods, st):
...
def plot_vcurve(smoothed, methods, st):
...
# =============================================================================
    ...
    plot_main(smoothed, methods, st)

    print_sopt(smoothed, methods, st)
...
# =============================================================================
    ...
    if vcurve:
        plot_vcurve(smoothed, methods, st)
